...
export const Header = () => {
  ...
  return (
    <div className="grid grid-flow-col p-2 shadow-lg sm:p-1">
        <div className="flex col-span-1">
            ...
            <img 
                className="w-16 h-4 px-2 sm:w-36 sm:h-10 sm:my-4 md:w-36 md:h-10"
                alt="logo" 
        ...
        <div className="flex justify-center items-center col-span-11 w-full sm:col-span-11 sm:mr-6 ">
            <input
